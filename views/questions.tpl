...
<script>
	$(function() {
		...
		$('.calc_util_quali').click(function() {
			...
			$('#curves_choice').append('<tr><td><input type="radio" classe=radio_choice" "value="Submit">         Table </td><br><tr><td><input type="radio" classe=radio_choice_1" "value="Submit"><td>         happy </td></tr>');
			$('.radio_choice').on('click', function() {
				$('#main_graph').show().empty();
