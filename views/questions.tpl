...
<script>
	$(function() {
		...
		$('.calc_util_quali').click(function() {
			...
			$('#curves_choice').append('<tr><td style="text-align:center"><input type="radio" classe=radio_choice" "value="Submit">Table</td><br><tr><td style="text-align:center"><input type="radio" classe=radio_choice_1" "value="Submit">histogram</td></tr>');
